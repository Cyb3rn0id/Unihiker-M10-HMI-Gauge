...
7. Transfer the entire *gauge_hmi* folder on the unihiker *home/* folder.  On Windows OS I like to use [WinSCP](https://winscp.net/eng/download.php) for transferring files. Default user/password on Unihiker are **root** / **dfrobot** and local address, when connected to the PC, is 10.1.2.3
